  ...
  return (
    <div className="container mx-auto p-6">
      ...
      <section className="mb-10">
        ...
        <div className="bg-green-50 p-6 rounded-lg shadow-md">
          <ul className="list-disc list-inside space-y-2 text-green-800">
            {privacyData
              .raw("privacyPromise.complianceRegulations")
              .map((regulation: string, index: number) => (
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <div className="bg-purple-50 p-6 rounded-lg shadow-md">
            ...
            <ul className="list-disc list-inside space-y-2 text-purple-700">
              {privacyData
                .raw("dataCollection.personalInformation")
          ...
          <div className="bg-red-50 p-6 rounded-lg shadow-md">
            ...
            <ul className="list-disc list-inside space-y-2 text-red-700">
              {privacyData
                .raw("dataCollection.sensitiveInformation")
                .map((info: string, index: number) => (
                  <li key={index}>{info}</li>
                ))}
            </ul>
      ...
      <section className="mb-10">
        ...
        <div className="space-y-4">
          {privacyData.raw("dataUsage.purposes").map(
            (
              purpose: {
                name: string;
                details: string;
      ...
      <section className="bg-gray-100 p-6 rounded-lg shadow-md">
        ...
        <p className="text-gray-700">{privacyData("policyUpdates.details")}</p>
