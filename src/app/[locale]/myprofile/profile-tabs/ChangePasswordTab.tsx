...
const ChangePasswordTab = ({ token }: { token: string }) => {
  ...
  const isFormValid =
    isPasswordValid && isPasswordMatch && formData.currentPassword.length > 0;
  ...
  return (
    <form
      ...
      className="space-y-6 bg-white  p-4 lg:px-20 rounded-2xl shadow-sm"
    >
        ...
        <div>
          ...
          <div className="relative">
            <input
              ...
              className="w-full bg-gray-100 rounded-2xl px-4 py-3 pr-12 outline-none focus:ring-2 focus:ring-blue-500 focus:bg-blue-50 focus:border-blue-300 transition-all duration-200 ease-in-out"
              required
              disabled={isLoading}
            />
            <button
